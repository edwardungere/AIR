...
### What this does
Searches the main index, and filters by logs originating from auth.log. Firther filters by looking for any logs containing any destionation users that were successfully logged into from a remote source not within tehe 10.0.0.0/16 network.
